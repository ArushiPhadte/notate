...
function addPanel() {
    ...
    panel.style.zIndex = "10000";
    panel.style.boxShadow = "0 5px 15px rgba(7, 9, 31, 0.3)";
    panel.style.fontFamily = "Charcoal";
    ...
    timeDisplay.style.color = "#444444ff";
    timeDisplay.style.marginBottom = "10px";
    timeDisplay.style.fontFamily = "Charcoal";
    panel.appendChild(timeDisplay);
    ...
    noteInput.style.resize = "none";
    noteInput.style.boxSizing = "border-box";
    noteInput.style.fontFamily = "Charcoal";
    panel.appendChild(noteInput);
    ...
    saveButton.style.marginTop = "8px";
    saveButton.style.marginRight = "5px";
    saveButton.style.fontFamily = "Charcoal";
    panel.appendChild(saveButton);
    ...
    toggleButton.style.cursor = "pointer";
    toggleButton.style.marginTop = "8px";
    toggleButton.style.fontFamily = "Charcoal";
    panel.appendChild(toggleButton);
    ...
    notesArea.style.padding = "10px";
    notesArea.style.backgroundColor = "#ffedb7ff";
    notesArea.style.fontFamily = "Charcoal";
    panel.appendChild(notesArea);
...
function displayNotes() {
    ...
    //if no notes
    if (videoNotes.length === 0) {
        notesArea.innerHTML = "<div style='text-align: center; font-size: 20px; color: #ffa913ff; padding: 20px; font-family: Charcoal;'>No notes yet!</div>";
        return;
    }
    ...
    if (showAllNotes == true) {
        ...
        if (video) {
            ...
            if (currentNote) {
                ...
                notesArea.innerHTML = "<div style='text-align: center; color: #ffab02ff; padding: 20px; font-family: Charcoal;'>No note for current time</div>";
            }
        }
    }
}
...
function createNoteElement(note, container) {
    ...
    noteDiv.style.borderRadius = "5px";
    noteDiv.style.borderLeft = "4px solid #ffa600ff";
    noteDiv.style.fontFamily = "Charcoal";
    ...
    timeSpan.style.cursor = "pointer";
    timeSpan.style.marginBottom = "5px";
    timeSpan.style.fontFamily = "Charcoal";
    ...
    textDiv.style.fontSize = "14px";
    textDiv.style.lineHeight = "1.4";
    textDiv.style.fontFamily = "Charcoal";
